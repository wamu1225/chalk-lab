...
export const glossary: GlossaryEntry[] = [
  ...
  },
  {
    term: '焼き石膏',
    reading: 'やきせっこう',
    description: '石膏を加熱して水分を飛ばしたもの。水を混ぜると化学反応（水和反応）でふたたび硬い石膏に固まり、一度固まると元の粉には戻りません。石膏チョークや手作りチョークキットの材料です。',
    relatedSectionId: 'making',
  },
  {
    term: '顔料',
  ...
  {
    term: 'ダストレスチョーク',
    description: '粉が舞い散りにくいように作られたチョーク。つぶの重い炭酸カルシウムを高密度に固め、消したときに粉が垂直に落ちやすくしています。',
    relatedSectionId: 'types',
  },
  {
