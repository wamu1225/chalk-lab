...
北海道ではホタテの貝殻が大量に出て、その処理が長年の課題でした。ホタテの貝殻は、実は高純度の炭酸カルシウム。チョークの主成分と同じです。そこに目をつけ、日本のメーカーと研究機関が協力して、貝殻を細かく砕いてチョークに配合する技術を開発しました。
...
✅ こうした取り組みは、ごみを減らしながら毎日使う道具を作る「資源の循環」の良い例として知られています。
...
⚠️ いまでも、廃業前に作られた本物の羽衣チョークは、ネットのオークションなどで高値で取引されることがあります。「ただのチョーク」が、コレクターズアイテムになっているのです。

## 韓国への技術継承

この名品が消えてしまうのを惜しんだのが、韓国で羽衣チョークの愛用者だった一人の人物でした。彼は私費を投じて日本を訪れ、製造機械や調合の技術、そして「HAGOROMO」の商標をゆずり受けます。

そして韓国に新しい会社を設立し、製造設備を移して生産を続けました。こうして、羽衣チョークの製法は国境をこえて受け継がれ、今も同等品質の製品が世界に届けられています。
...
円石藻は、炭酸カルシウムでできた小さな殻（コッコリスと呼ばれます）を身にまとっています。この生き物が大量に死んで海の底にしずみ、殻が長い長い年月をかけて積もり、押し固められて白い地層になりました。それが白亜です。
