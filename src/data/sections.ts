...
CUDという考え方そのものは、チョークにかぎらず標識や資料の配色にも共通します。なぜ色だけに頼ると情報が届かない人が出るのかは、[カラーユニバーサルデザイン（CUD）とは](/color-uc/1-2-color-universal-design/) で扱っています。
...
羽衣チョークの歩みを、時期ごとにまとめると次のようになります。

| 時期 | 出来事 |
|---|---|
| 生産期 | 「チョーク界のロールスロイス」と呼ばれ、世界の数学者に愛用された |
| 2015年 | 羽衣文具が廃業。世界的な買いだめ騒動（Chalkapocalypse）が起きた |
| 廃業後 | 韓国の愛用者が製造設備と商標を受けつぎ、生産を再開した |
...
色で分けて書くときの注意は、黒板でもホワイトボードでも変わりません。色味の違いだけに頼らず明るさの差をつける、模様や色名も添える、といった工夫は [色のUDの基本テクニック](/color-uc/6-1-cud-techniques/) にまとまっています。
...
三つのスポーツ・裁縫用チョークを並べると、成分も役割もそれぞれ違うことが分かります。

| 使う場面 | 主な成分 | 役割 |
|---|---|---|
| クライミング・体操 | 炭酸マグネシウム | 手の汗を吸って乾かし、すべりを防ぐ |
| ビリヤード | ケイ酸塩など | キュー先と球のあいだに摩擦をつける |
| 裁縫（チャコ） | ロウ（ワックス）が多い | 布に印をつけ、あとできれいに消す |
...
| 黒板消しを手でたたかない | たたくと粉が一気に舞う。専用のクリーナーで吸い取るのが理想 |
| こまめに換気する | 空気を入れかえると、粉が室内にこもりにくい |
| 粉受け（チョークトレー）をふく | たまった粉を濡らしてからふき取ると舞わない |
...
正しく付き合えば、チョークは安全で扱いやすい道具です。`,
  ...
  {
    id: 'history',
    title: 'チョークと黒板の歴史｜寺子屋の塗板から緑の黒板まで',
    shortTitle: '歴史',
    description: '黒板はいつ日本に来た？なぜ緑なのに「黒板」？寺子屋の塗板から、明治の伝来、国産白墨の誕生、緑の黒板まで、チョークと黒板の歴史をたどります。',
    icon: 'blackboard-origin',
    emoji: '🏫',
    lead: '毎日見ている黒板とチョーク。実は「黒板が日本に来た日」も「黒い板が緑になった理由」も、ちゃんと記録が残っています。寺子屋の時代から現代まで、チョークと黒板の歴史の旅に出かけましょう。',
    kidSummary: '黒板は明治のはじめにアメリカからやってきた。さいしょは本当に「黒い板」で、あとから緑色になったんだ。',
    toc: [
      '黒板はどこから来た？',
      '「黒板」という名前のひみつ',
      '国産黒板のはじまり',
...
📖 「一度に大勢へ教える」授業のかたちと黒板はセットで広まりました。黒板がなぜ教室の主役になれたのかは、[チョーク vs ホワイトボード](/chalk-lab/whiteboard/) のページも参考になります。
...
黒板の体も進化を続けます。明治の黒板は杉板をカンナで仕上げたものでしたが、昭和20年代後半には合板、昭和30年代にはスチール（鋼板）下地が普及。いまでは [ホーロー](/chalk-lab/whiteboard/) など、丈夫で長持ちする表面材が主流になっています。
...
最初の国産白墨が「七輪で石膏を焼いて」作られたというのは、なんとも手作り感のあるエピソードです。焼き石膏に水を混ぜると固まる性質は、[チョークの作り方](/chalk-lab/making/) で説明したとおり。現在の学校では、粉が舞いにくい炭酸カルシウム製の [ダストレスチョーク](/chalk-lab/types/) が主流になっています。

✅ 名品として世界に知られた [羽衣チョーク](/chalk-lab/hagoromo/) も、この国産チョークの歴史の延長線上に生まれました。
...
ふだん何気なく見ている教室の道具に、150年の歴史が詰まっています。`,
    updatedAt: '2026-06-10',
    references: [
      { label: '全国黒板工業連盟（公式）｜黒板の歴史（1872年スコットが大学南校へ・国産初の黒板・「黒板」の名の由来）', url: 'https://www.kokuban.or.jp/history/' },
      { label: '株式会社馬印（公式）｜黒板の話（1950年代JIS規格で塗面が黒→緑へ・チョークの日本史・塗料と構造の変遷）', url: 'https://www.uma-jirushi.co.jp/story' },
    ],
  },
];
