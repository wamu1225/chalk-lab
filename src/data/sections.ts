...
- **蛍光チョーク（ルミナス系）**：顔料を多めに入れて、暗い教室でもくっきり見えるようにしたもの。発色が強い反面、やや消えにくくなるため、別珍（ベロア）生地の黒板消しが向いています。
...
そのため、学校など多くの人が長時間すごす場所では、空気中の粉じんを一定以下に保つための基準が定められており、換気や掃除の工夫がされています。
