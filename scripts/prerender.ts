...
writeStaticPage('quiz', 'チョーク検定（クイズ）', 'チョークの科学・歴史・トリビアから、全30問の中より毎回ランダムに10問を出題するクイズ。読んだ知識を力だめしできます。',
  `<p style="color:#4b5b51;font-size:1.05rem;margin:16px 0 24px">全30問の中から、毎回ランダムに10問を出題。8問以上の正解で合格です。選択肢の並びも毎回シャッフルされ、連続正解でコンボが続きます。さらに「今日の検定」は全員おなじ10問で、毎日挑戦すると連続記録（デイリーストリーク）がのびます。よみものを読んでから挑戦すると解きやすくなります。</p>
